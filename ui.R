        ...
        tabPanel("Scenarios",
          ...
          label = NULL,
            choiceNames = list(
              ...
              info("Scheme 2", "Migration is allowed at increasing rates once heterozygosity drops to a set threshold. In this example migration rates are predetermined to be: 1/(20*N), 1/(10*N), 1/(6*N), 1/(4*N), 1/(2*N), 1/N, 2/N, and 3/N. Therefore each time the local heterozygosity drops below the threshold the migration rate is increased. Any alternative rates can be chosen. See supplementary sections 1 and 2.")
              ),
